...
import com.mohammadbesharat.atlasmeat.repository.DayLimitRepository;
...
public class OrderService {
    ...
    public OrderService(OrderRepository orderRepository, DayLimitRepository dayLimitRepository){
